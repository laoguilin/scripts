...
!(async () => {
  ...
  .catch((e) => $.logErr(e))
  .finally(() => $.done())
//https://www.xiaeke.com/benmao/index.php/Home/MorningTree/gainEnergy?user_id=93935&energy_type=0&energy=10
...
let url = {
    ...
    data = JSON.parse(data)
        if(data.status == 13000){
            console.log("浇水成功"+data.info);  
} else {
    console.log("浇水失败"+data.info);
